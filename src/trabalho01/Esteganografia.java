...
/*carrega a imagem*/
    ...
    public void salvarImagem(BufferedImage img, int[] pixels, int w, int h, String novaimg) {
        ...
        try {
            ...
            System.out.println("Salvando imagem..." + novaimg + " ...");
    ...
    public void InserirMensagem(BufferedImage img, String destino, String mensagem) {
      ...
      //      System.out.println("teste: "+binario);
